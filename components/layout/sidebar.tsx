...
const navigation = [
  ...
  { name: 'Time Tracking', href: '/time-tracking', icon: Clock, roles: ['hr', 'project_manager', 'employee'] },
  { name: 'Attendance Tracking', href: '/time-tracking/admin', icon: Users, roles: ['super_admin', 'hr'] },
